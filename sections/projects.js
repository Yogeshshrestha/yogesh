...
const PROJECTS = [
  {
    ...
    rank: 'S',
    rankColor: '#ff2d55',
    description: 'Leading NFT platform on Aptos. Built the wallet connection layer (Petra & Martian), minting flows, collection management, and marketplace UI on top of Move smart contracts.',
    tech: ['Nuxt 3', 'Vue 3', 'Aptos SDK', 'Move Smart Contracts', 'Pinia', 'TypeScript', 'Tailwind CSS'],
    status: 'completed',
  ...
  },
  {
    ...
    rank: 'S',
    rankColor: '#ffd700',
    description: 'AI-powered cybersecurity platform for pen testing, vulnerability analysis, code/document review, and compliance auditing (ISO 27001, PCI DSS, SOC 2). Users chat with AI, upload PDFs/DOCX, and get streamed security analysis.',
    tech: ['Nuxt 3', 'Vue 3', 'Vuetify 3', 'Pinia', 'TypeScript', 'Tailwind CSS', 'Axios', 'GraphQL', 'DOMPurify', 'jsPDF', 'Vitest'],
    status: 'completed',
  ...
  {
    id: 'mokshya-io',
    title: 'Mokshya Protocol',
    type: 'WEB3 / HEADLESS CMS',
    category: 'web3',
    rank: 'A',
    rankColor: '#8b5cf6',
    description: 'Public website for a Web3 open-source org building smart contracts, SDKs, infrastructure, and dApps across Ethereum, Bitcoin, Aptos, Solana, and Sui. Homepage, blog, and donation hub for the Mokshya ecosystem.',
    tech: ['Nuxt 3', 'Vue 3', 'TypeScript', 'Pinia', 'GraphQL', 'GSAP', 'Axios'],
    status: 'completed',
